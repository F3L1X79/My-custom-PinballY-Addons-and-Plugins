...
- **Entrées du menu principal** après « Jouer » : Succès personnels, Configuration de la table, table au hasard, table du jour, table de la semaine, Changer de joueur (un carrousel d'Avatars piloté par les flippers).
