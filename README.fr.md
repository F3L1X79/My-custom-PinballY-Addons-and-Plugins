...
- **Entrées du menu principal** après « Jouer » : Changer de joueur (un carrousel d'Avatars piloté par les flippers, aussi dans le menu Quitter ; l'Avatar et le nom du Profile actif restent en haut à droite de l'écran de la roue ; choisir un Profile accueille le joueur, et démarrer PinballY aussi quand le dialogue de démarrage est désactivé), Succès personnels, Configuration de la table, table au hasard, table du jour, table de la semaine.
