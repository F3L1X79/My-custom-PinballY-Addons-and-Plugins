...
export default {
    ...
    profileStats: {
        ...
        tableOfTheDayStreak: (count, longest) => `Sequência Mesa do dia: ${count} (recorde ${longest})`,
        tableOfTheWeekStreak: (count, longest) => `Sequência Mesa da semana: ${count} (recorde ${longest})`,
        back: "Voltar",
    },
